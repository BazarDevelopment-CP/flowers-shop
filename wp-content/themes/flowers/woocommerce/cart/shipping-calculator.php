<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ) ?>" method="post">
	...
	<section class="shipping-calculator-form" style="display:none;">
        ...
        <?php else: ?>    
            ...
            <input type="hidden" name="calc_shipping_country" value="US">
        ...
        <?php else: ?>
            ...
            <input type="hidden" name="calc_shipping_state" value="WA">
		...
		<button type="submit" name="calc_shipping" value="1" class="<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ) ?> shop-btn"><?php esc_html_e( 'Update', 'woocommerce' ) ?></button>
